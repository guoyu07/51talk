...
(function(){
    ...
    _17kouyu.jssdkVersion = "3.0.18";
    _17kouyu.apiVersion = "v3.0";
    
    //_17kouyu.host = _17kouyu.host || (window.location.protocol == "https:" ? "https://sdk.17kouyu.com/jssdk/" : "http://sdk.17kouyu.com/jssdk/") + _17kouyu.apiVersion;
	_17kouyu.host = (_17kouyu.host || "https://sdk.17kouyu.com/jssdk/") + _17kouyu.apiVersion;
	_17kouyu.mode = {
		FLASH: 1,       /*默认加载flash模式*/
		H5: 2,		  /*加载h5*/
      H5_FIRST: 3         /* 优先加载html5，失败时加载flash*/
    };
   ...
   // _17kouyu.getCss(_17kouyu.host + "/Resources/themes/default/ui.css");
    ...
    _17kouyu.logId = generateGUID();
	 ...
	 _17kouyu.getScript( "/js/17kouyu/ijquery-1.6.2-min.js");
	 _17kouyu.getScript( "/js/17kouyu/17kouyu-min.js");
})();
